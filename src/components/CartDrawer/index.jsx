  ...
  return (
    <>
        ...
        <div className="flex-1 p-4 overflow-y-auto space-y-4">
          {cart.length === 0 ? (
            ...
            cart.map((item, idx) => {
              ...
              return (
                <div
                  key={`${item.id}-${item.color ?? "nc"}-${item.size ?? "ns"}-${idx}`}
                  className="
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[13px] text-gray-600">
                      {item.size ? <span>Talle: {item.size}</span> : null}
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      >
                        <RemoveIcon fontSize="small" className="text-gray-700" />
                      </IconButton>

                      <span className="w-8 text-center text-[14px] text-gray-800">
                        {qty}
                      </span>
                      ...
                      <IconButton
                        ...
                        onClick={() => canInc && incrementItem(idx)}
                        disabled={!canInc}
                        sx={{
                          bgcolor: "white",
                          borderRadius: "8px",
                      ...
                      >
                        <AddIcon fontSize="small" className="text-gray-700" />
                      </IconButton>
        ...
        <div className="border-t border-gray-200 p-4 space-y-3">
          ...
          <Button
            ...
            sx={{
              mt: 1,
              textTransform: "none",
              color: cart.length === 0 ? "text.disabled" : "error.main",
              "&:hover": { bgcolor: "rgba(244, 63, 94, 0.08)" }, // rose-500/8
            }}
          >
            Vaciar carrito
          </Button>
      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)} maxWidth="xs" fullWidth>
        ...
        <DialogContent>
          ¿Seguro que querés eliminar <b>todos</b> los productos del carrito?
        </DialogContent>
        <DialogActions>
